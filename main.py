...
slider1 = Scale(root, from_=0, to=12, orient=HORIZONTAL, length=200, **style, command=slider_changed,variable=current_value1)
...
slider2 = Scale(root, from_=0, to=12, orient=HORIZONTAL, length=200, **style, command=slider_changed,variable=current_value2)
...
slider3 = Scale(root, from_=0, to=12, orient=HORIZONTAL, length=200, **style, command=slider_changed,variable=current_value3)
...
slider4 = Scale(root, from_=0, to=12, orient=HORIZONTAL, length=200, **style, command=slider_changed,variable=current_value4)
...
pbar1 = ttk.Progressbar(root, maximum=12, value=get_current_value1(), orient="vertical")
pbar1.pack(side=LEFT)
pbar2 = ttk.Progressbar(root, maximum=12, value=get_current_value2(), orient="vertical")
pbar2.pack(side=LEFT)
pbar3 = ttk.Progressbar(root, maximum=12, value=get_current_value3(), orient="vertical")
pbar3.pack(side=LEFT)
pbar4 = ttk.Progressbar(root, maximum=12, value=get_current_value4(), orient="vertical")
