...
BG = go_back_home=gamecanva.create_image(garums/2,platums/2,image=img_BG)
...
legs = go_back_home=gamecanva.create_image(400,344,image=img_legs)
img_head = PhotoImage(file="person/Head/head_red.png")
head = go_back_home=gamecanva.create_image(400,75,image=img_head)
img_body = PhotoImage(file="person/Body/body_green.png")
body = go_back_home=gamecanva.create_image(400,182,image=img_body)
